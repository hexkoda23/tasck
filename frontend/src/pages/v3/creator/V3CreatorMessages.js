  ...
  const threads = [
    {
      ...
      brand: 'Guinness',
      rm: getRM('rm-adaeze'),
      lastMessage: 'The Creative Snapshot v1 is drafted and under internal review. I\'ll share it with you before it goes to Tunde.',
      time: '3 hours ago',
      unread: 1,
      messages: [
        ...
        { id: 'cm3', sender: 'Adaeze Obi', senderType: 'rm', time: '4 days ago', text: 'Noted. I\'ve built the Obongjayar conversation into the Creative Snapshot timeline. His team would need confirmation by end of April if we\'re shooting in October. Is that workable?' },
        ...
        { id: 'cm6', sender: 'Rema', senderType: 'creator', time: '3 days ago', text: 'Perfect. One more thing — I want final edit. That was in my brief response but I want it confirmed in the contract, not just the Creative Snapshot.' },
        { id: 'cm7', sender: 'Adaeze Obi', senderType: 'rm', time: '3 hours ago', text: 'Understood — I\'ve flagged this for the contracts team. It\'ll be a clause with a brand safety carve-out (standard TASCK practice). The Creative Snapshot v1 is drafted and under internal review. I\'ll share it with you before it goes to Tunde\'s team.' },
      ],
    },
    {
      id: 'ct-puma',
