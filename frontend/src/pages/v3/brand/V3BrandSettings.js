...
import { getBrand } from '../../../lib/v3data';
      ...
      <div className="space-y-6">
        <div className="v3-card p-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between py-1.5 border-b border-[#F4F2EC]"><span className="text-[13px] text-[#8A8A8A]">Primary contact</span><span className="text-[13px] text-[#1A1A1A]">{brand?.primaryContact}</span></div>
            <div className="flex justify-between py-1.5 border-b border-[#F4F2EC]"><span className="text-[13px] text-[#8A8A8A]">Email</span><span className="text-[13px] text-[#1A1A1A]">{brand?.email}</span></div>
