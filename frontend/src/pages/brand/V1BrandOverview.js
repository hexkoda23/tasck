...
const V1BrandOverview = () => {
  ...
  // Bundles are already sanitised, so a pitch deck only appears here once
  // admin has actually sent it to the brand page.
  const pitchDeckReady = bundles.some((bundle) => bundle?.pitch_deck);
