...
const notifications = [
  ...
  { id: 'n3', type: 'approval', icon: FileText, color: '#1F4A3A', title: 'Guinness Strategy Snapshot ready for review', desc: 'Adaeze Obi completed internal review of v1. Ready to share with Tunde Adeola.', time: '1 day ago', action: '/v3/admin/projects/proj-guinness-rema', read: false },
